...
for card in sfp_cards:
    ...
    for phy in card.phys:
        for m in phy.modules:
            print('\t\tPhy(%i) channel(%i):' % (phy.id, m.id), end=' ')
            print(m.read_temp()[1], end=' ')
            print(m.read_voltage()[1], end=' ')
            print(m.read_tx_bias_current()[1], end=' ')
            print(m.read_tx_power()[1], end=' ')
            print(m.read_rx_power()[1], end=' ')
            print(m.read_stat()[1])
